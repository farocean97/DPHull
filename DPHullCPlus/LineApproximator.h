...
public:
	...
	*/
	static T SqrDist( const typename TPointContainer::const_iterator& p, const typename TPointContainer::const_iterator& q)
	{
		T dx=p->x-q->x;
		T dy=p->y-q->y;
		return dx*dx+dy*dy;
	...
	*/
	static void CrossProduct( const typename TPointContainer::const_iterator& p, const typename TPointContainer::const_iterator& q, SHomog& r)
	{
			r.w = p->x * q->y - p->y * q->x;
			r.x = - q->y + p->y;
			r.y = q->x - p->x;
	...
	*/
	static T DotProduct( const typename TPointContainer::const_iterator& p, const SHomog& q)
	{
	...
	*/
	static T DotProduct( const typename TPointContainer::const_iterator& p, const typename TPointContainer::const_iterator& q)
	{
	...
	*/
	static void LinComb( T a, const typename TPointContainer::const_iterator& p, T b, const typename TPointContainer::const_iterator& q, const typename TPointContainer::const_iterator& r)
	{
		r->x = a * p->x + b * q->x;
		r->y = a * p->y + b * q->y;
	};
...
namespace priv
{
	...
	{
		bool operator()( const typename Container::value_type& p1, const typename Container::value_type& p2)	
